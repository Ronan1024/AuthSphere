...
public class SubjectTypeServiceImpl extends ServiceImpl<SubjectTypeMapper, SubjectType>
    ...
    public List<SubjectTypeResponse> listAll() {
        List<SubjectType> subjectTypeList = subjectTypeMapper.selectList(new LambdaQueryWrapper<SubjectType>()
                .eq(SubjectType::getStatus, StatusEnum.NORMAL.getCode()));
        return SubjectTypeConvert.INSTANCE.toSubjectTypeResponse(subjectTypeList);
    }
